...
int z_axis_height = 30; //in cm         //Maximum height of the scaned file
...
float lead_screw_rotations_per_cm = 1.25;    //How many rotations needs the lead screw to make in order to make 1cm. 
int steps_per_rotation_for_motor = 200; //Steps that the motor needs for a full rotation. 
int distance_to_center = 22;             //In cm. Distance from sensor to the turntable center in cm
/// MISO = 19
/// MOSI = 23
/// SCK = 18
/// CS = 5
//SPI pins of the ESP32 are: MOSI GPIO23, MISO GPIO 19, SCK GPIO 18 and CS GPIO 5
int button = 21;
int limit_switch = 22;
...
double getDistance()
{
  ...
  distance = mapFloat(distance,0.0,4095.0,0.0,3.3); //Convert analog pin reading to voltage
